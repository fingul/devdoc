...
중요한 부분은 `@@`, 더 중요한 부분은 `@@@@`로 표시
        ...
        -d, --daemon, --no-daemon      Run as daemon process (default disabled)
            ...
            --file-logging, --no-file-logging 
                                        Log to file (default enabled)
                Log all VLC messages to a text file. (default enabled)
            --syslog, --no-syslog      Log to syslog (default enabled)
                Log all VLC messages to syslog (UNIX systems). (default enabled)
